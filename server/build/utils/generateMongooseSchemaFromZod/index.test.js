...
describe("generateMongooseSchemaFromZod", () => {
    describe("simple types", () => {
        ...
        it("should manage litterals", () => {
            const schema = generateMongooseSchemaFromZod(z.object({
    ...
    describe("complex types", () => {
        ...
        it("should manage discrimated union at root", () => {
            const schema = generateMongooseSchemaFromZod(z.discriminatedUnion("type", [
        ...
        it("should manage discrimated union deeper in array", () => {
            const schema = generateMongooseSchemaFromZod(z.object({
                params: z.array(z.discriminatedUnion("type", [
                    z.object({ type: z.literal("min"), min: z.number() }),
                    z.object({ type: z.literal("text"), text: z.string() }),
                ])),
            }));
    ...
    describe("default schema", () => {
        ...
        it("should add custom typedKey", () => {
            ...
            }), undefined, undefined, { typedKey: "$type" });
            const expected = {
                params: {
                    $type: {
                        sub: {
    ...
    describe("errors", () => {
        it("should throw an error if _id exists at zod root", () => {
            expect(() => generateMongooseSchemaFromZod(z.object({
                name: z.string(),
                _id: z.string(),
        ...
        it("should throw an error if _id exists in union object root", () => {
            expect(() => generateMongooseSchemaFromZod(z.union([
                z.object({
                    name: z.string(),
                    _id: z.string(),
                }),
        ...
        it("should throw an error if _id exists in discriminated union object root", () => {
            expect(() => generateMongooseSchemaFromZod(z.discriminatedUnion("type", [
                z.object({
                    type: z.literal("name"),
                    name: z.string(),
                    _id: z.string(),
