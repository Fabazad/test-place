...
const PrivacyPolicyModal = ({ t }) => {
  ...
  useEffect(
    () => setIsOpen(history.location.hash === "#privacyPolicy"),
  ...
  return (
    ...
    >
      <div className="modal-header">
        <h2 className="modal-title">{t("PRIVACY_POLICY")}</h2>
        <button
          aria-label="Close"
          className="close"
          data-dismiss="modal"
      ...
      <div className="modal-body white-space-pre-line">
        <h3 className="mb-4">En vigueur au 09/08/2024</h3>
        <div className="text-muted font-weight-light text-left mb-5">
          ...
          services par et de définir les conditions d’accès et d’utilisation des services
          par « l'Utilisateur ». <br />
          Les présentes CGU sont accessibles sur le site à la rubrique «CGU».
          <br />
          Toute inscription ou utilisation du site implique l'acceptation sans aucune
          réserve ni restriction des présentes CGU par l’utilisateur.
          <br /> Lors de l'inscription sur le site via le Formulaire d’inscription, chaque
          utilisateur accepte expressément les présentes CGU en cochant la case précédant
          le texte suivant : « Je reconnais avoir lu et compris les CGU et je les accepte
          ».
          <br />
          ...
          <br />
          https://test-place.fr se réserve le droit de modifier unilatéralement et à tout
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          L'édition du site https://test-place.fr est assurée par la Société Société Test
          Place au capital de 1000 euros, <br />
          immatriculée au RCS de Montpellier sous le numéro 000 000 000, dont le siège
          social est situé au Avenue d’assas <br />
          Numéro de téléphone 0664160119 <br />
          Adresse e-mail : test-place@gmail.com. <br />
          Le Directeur de la publication est : Turgut Fabien <br />
          L'hébergeur du site https://test-place.fr est la société Heroku, dont le siège
          social est situé au Heroku companie, avec le numéro de téléphone : 0600000000.
        </div>

        <h2>ARTICLE 2 : ACCÈS AU SITE</h2>

        <div className="text-muted font-weight-light text-left mb-5">
          Le site https://test-place.fr permet à l'Utilisateur un accès gratuit aux
          services suivants : <br />
          Le site internet propose les services suivants :<br />
          Proposer des tests de produits Le site est accessible gratuitement en tout lieu
          à tout Utilisateur ayant un accès à Internet. Tous les frais supportés par
          ...
          s’inscrire en remplissant le formulaire. <br />
          En acceptant de s’inscrire aux services réservés, l’Utilisateur membre s’engage
          à fournir des informations sincères et exactes concernant son état civil et ses
          ...
          désinscription en se rendant à la page dédiée sur son espace personnel. Celle-ci
          sera effective dans un délai raisonnable.
          <br />
          ...
          https://test-place.fr.
          <br /> Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          ...
          janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site
          est déclaré à la CNIL sous le numéro 000000000000.
          <br />
          ...
          <br /> L'Utilisateur exerce ce droit : · via un formulaire de contact ;<br />·
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          ...
          <br /> Il s'engage à une utilisation des contenus du site dans un cadre
          strictement privé, toute utilisation à des fins commerciales et publicitaires
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          Les sources des informations diffusées sur le site https://test-place.fr sont
          réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts,
          d’erreurs ou d’omissions.
          <br />
          Les informations communiquées sont présentées à titre indicatif et général sans
          valeur contractuelle. <br />
          Malgré des mises à jour régulières, le site https://test-place.fr ne peut être
          tenu responsable de la modification des dispositions administratives et
          juridiques survenant après la publication.
          <br /> De même, le site ne peut être tenue responsable de l’utilisation et de
          l’interprétation de l’information contenue dans ce site.
          <br />
          L'Utilisateur s'assure de garder son mot de passe secret. <br />
          ...
          <br /> Le site décline toute responsabilité.
          <br />
          Le site https://test-place.fr ne peut être tenu pour responsable d’éventuels
          virus qui pourraient infecter l’ordinateur ou tout matériel informatique de
          l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant
          de ce site.
          <br />
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          ...
          <br /> L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du
          site https://test-place.fr. <br />
          Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          ...
          s’installer automatiquement sur son logiciel de navigation. <br />
          ...
          l’utilisation du site https://test-place.fr. <br /> Les cookies ne contiennent
          pas d’information personnelle et ne peuvent pas être utilisés pour identifier
          quelqu’un. <br />
          Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme.{" "}
          <br />
          Certains cookies expirent à la fin de la visite de l’Utilisateur, d’autres
          restent. <br />
          L’information contenue dans les cookies est utilisée pour améliorer le site
          https://test-place.fr. <br />
          En naviguant sur le site, L’Utilisateur les accepte. <br />
          L’Utilisateur doit toutefois donner son consentement quant à l’utilisation de
          certains cookies. <br />
          A défaut d’acceptation, l’Utilisateur est informé que certaines fonctionnalités
          ou pages risquent de lui être refusées. <br />
        ...
        <div className="text-muted font-weight-light text-left mb-5">
          Le site permet aux membres de publier les contenus suivants : Produits à tester.
          <br />
          ...
          vigueur.
          <br />
          Le site peut exercer une modération sur les publications et se réserve le droit
          de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre.
          <br />
          Le membre reste titulaire de l’intégralité de ses droits de propriété
          intellectuelle.
          <br /> Mais en publiant une publication sur le site, il cède à la société
          ...
          autorisé, dans le monde entier, sur tout support (numérique ou physique), pour
          la durée de la propriété intellectuelle.
          <br /> Le Membre cède notamment le droit d'utiliser sa publication sur internet
          et sur les réseaux de téléphonie mobile.
          <br />
          La société éditrice s'engage à faire figurer le nom du membre à proximité de
          ...
          atteinte aux intérêts de tierces personnes.
          <br /> Tout recours en justice engagé par un tiers lésé contre le site sera pris
